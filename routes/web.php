...
Route::middleware('auth')->prefix('admin')->group(function () {
    ...
    Route::prefix('students')->group(function () {
        ...
        Route::post('/create', [StudentController::class, 'edit'])->name('students.edit');
        Route::post('/create', [StudentController::class, 'update'])->name('students.update');
        Route::post('/create', [StudentController::class, 'destroy'])->name('students.destroy');
    });
